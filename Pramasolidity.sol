...
contract BullShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull Shiba Inu";
    string private _symbol = "BullShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92CC8a570F389E91905e34b54f1343b86224aD5f); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x92CC8a570F389E91905e34b54f1343b86224aD5f); // buyback Address
